...
class DetailsPage extends StatefulWidget {
  ...
  final foodPrice;
  final refresh;
  DetailsPage({this.heroTag, this.foodName, this.foodPrice,this.refresh});
                  ...
                  children: <Widget>[
                    ...
                    InkWell(
                      onTap: (){
                         setState(() {
                              widget.refresh();
                              fixedicon().createState().increasecart(orderitem(widget.foodName,widget.foodPrice,quantity.toString(),false));
                           });
                      },
                      ...
                      child: Padding(
                        ...
                        child: Container(
                          ...
                          child: Center(
                            child: Text(
                            (quantity*(int.parse(widget.foodPrice))+options).toString()+" "+"L.e",
                                style: TextStyle(
                                    color: Colors.white,
                                    fontFamily: 'Montserrat'
                                )
